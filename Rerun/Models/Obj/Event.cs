...
namespace Rerun.Models.Obj
{
    ...
    {
        EventTypeSpecialStage = 1,  // Broken in 2.0, provided a special endless stage and special event objects to collect
        EventTypeRaidBoss,          // Broken in 2.0, a boss would strike randomly, and you and other people have to face off against it
        EventTypeCollectObject,     // Partially broken in 2.0, a notable example is the Animal Rescue Event
        EventTypeGacha,             // Showcase buddies on the roulette for a limited time - it seems Sonic Team was working on a minor revamp for this type for 2.0
        EventTypeAdvert,            // apparently like the gacha event type...?
